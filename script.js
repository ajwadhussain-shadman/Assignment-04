...
for (const btn of buttons) {
   btn.addEventListener('click', function (event) {
      ...
      if (clickedBtn.classList.contains('interview-btn')) {
         ...
         statusBox.classList.remove('text-[#002C5C]', 'bg-[#EEF4FF]', 'border-red-600', 'bg-red-500');
         statusBox.classList.add('border', 'border-green-600', 'bg-green-500', 'text-white', 'font-extrabold');
         ...
         statusBox.classList.remove('text-[#002C5C]', 'bg-[#EEF4FF]', 'border-green-600', 'bg-green-500');
         statusBox.classList.add('border', 'border-red-600', 'bg-red-500', 'text-white');
